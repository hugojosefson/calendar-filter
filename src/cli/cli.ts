      ...
      serveCalendarFilter({
        serverOptions: {
          ...
          onListen({ hostname, port }) {
            console.log(
              `calendar-filter listening on http://${hostname}:${port}/webcal`,
            );
          },
        },
