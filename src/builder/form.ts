/** @module Builder form parsing and operations. */

import { createBuilderState, describePattern } from "./codec.ts";
import {
  addBuilderRule,
  moveBuilderRule,
  removeBuilderRule,
...
/** Converts bounded builder form fields to serializable state. */
...
/** Applies a named button operation without trusting out-of-range indexes. */
