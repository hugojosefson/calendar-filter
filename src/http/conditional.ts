/** @module Conditional request helpers. */

/** Hashes a representation as a quoted, strong SHA-256 ETag. */
...
/** Checks a syntactically valid If-None-Match header against a strong ETag. */
...
/** Parses ETags strictly so malformed conditional headers never match. */
...
/** Skips HTTP optional whitespace between ETag tokens. */
