...
/** Returns whether a literal IPv4 or IPv6 address is safe for public upstream use. */
...
/** Tests whether an address begins with a network prefix. */
function hasPrefix(
  address: bigint,
  network: bigint,
  prefixLength: number,
...
/** Parses canonical dotted decimal without accepting browser-specific shorthand. */
...
/** Parses IPv6 including an embedded IPv4 tail into 128 bits. */
...
/** Formats the low 32 bits of an address as dotted IPv4. */
